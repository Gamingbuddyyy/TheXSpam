...
async def raid(xspam: Client, message: Message):  
      ...
      if len(alt) > 2:
            ...
            id = ok.id
            if id in THE_ALTS:
                  await message.reply_text("» ɴᴏ, ᴛʜɪꜱ ɢᴜʏ ɪꜱ sahenshah'ꜱ ᴏᴡɴᴇʀ")
            elif id == OWNER_ID:
                  await message.reply_text("» ɴᴏ, ᴛʜɪꜱ ɢᴜʏ ɪꜱ baap ᴏꜰ ᴛʜᴇ ʙᴏᴛꜱ.")
...
async def rraid(xspam: Client, message: Message):
      ...
      if len(alt) > 1:
          ...
          if id in THE_ALTS:
              ...
              rusers.append(id)
              await message.reply_text("» ab gaali sun !! ✅")
...
async def draid(xspam: Client, message: Message):
      ...
      if len(alt) > 1:
          ...
          if id in rusers:
              rusers.remove(id)
              await message.reply_text("» sun liya na gaali  !! ✅")
